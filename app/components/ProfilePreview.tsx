...
export default function ProfilePreview({
  ...
  return (
  <div
    className="relative mx-auto h-full w-full max-w-md overflow-y-auto rounded-3xl border border-white/10"
...
{/* Overlay per leggibilità - DISATTIVATO PER TEST */}
{/* {bgVideoUrl && (
  <div
    ...
    style={{
      zIndex: 1,
      background:
        "linear-gradient(to bottom, rgba(12,13,18,0.55), rgba(12,13,18,0.82))",
    }}
  />
)} */}
